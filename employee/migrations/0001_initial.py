    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut_rh', models.CharField(choices=[('pending', 'En attente'), ('approved', 'Approuvé'), ('rejected', 'Rejeté')], default='pending', max_length=10)),
                ('employe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='leave', to='employee.employemodels')),
            ],
            options={
                'abstract': False,
            },
